...
export default function Home() {
  ...
  const handleAddResident = (newResidentName: string): Resident => {
    ...
    toast({ title: "Novo morador adicionado!", description: `${newResidentName} foi adicionado(a) à lista de moradores.` });
    return newResident;
  };
